...
class PurchaseReturnStatementReport extends StatefulWidget {
  const PurchaseReturnStatementReport({Key? key}) : super(key: key);

  @override
  State<PurchaseReturnStatementReport> createState() =>
      _PurchaseReturnStatementReportScreenState();
}

class _PurchaseReturnStatementReportScreenState extends State<PurchaseReturnStatementReport> {
  ...
  void _fetchReport() {
    ...
    context.read<PurchaseReportViewModel>().fetchReportReturnStmtReport(
      fromDate: fromDate,
      toDate: toDate,
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          pw.Center(
            child: pw.Text(
              Strings.purchaseReturnStatement,
          ...
          pw.Table.fromTextArray(
            ...
            headers: [
              ...
              Strings.date,
              Strings.qty,
              Strings.freeQtyLabel,
              Strings.subtotalLabel,
              Strings.taxableAmtLabel,
              Strings.taxAmtLabel,
              Strings.postage,
              Strings.roundOff,
              Strings.disc,
...
// ✅ Set first location as default
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(  Strings.purchaseReturnStatement,
                        ...
                        Expanded(
                          ...
                          child: DropdownButtonFormField<int>(
                            ...
                            decoration: InputDecoration(
                              labelText: Strings.stockLocation,                              border: OutlineInputBorder(
                        ...
                        Expanded(
                          ...
                          child: InkWell(
                            ...
                            child: InputDecorator(
                              decoration: InputDecoration(
                                labelText: Strings.dateRange,                                prefixIcon:
                    ...
                    child: purchaseItems.isEmpty
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ReportCard(
                          ...
                          dateLabel: 'Date',
                          fields: const {
                            Strings.billNo: "SupplierBillNo",
                            Strings.qty: "TotalQty",
                            Strings.freeQtyLabel: "FreeQty",
                            Strings.subTotal: "SubTotal",
                            Strings.taxableAmt: "TaxableAmt",
                            Strings.taxAmt: "TotalTaxAmt",
                            Strings.postage: "OtherCharges",
                            Strings.roundOff: "RoundOff",
                            Strings.netAmt: "NetAmt",
                          },
                          accentColor: primary,
                        );
                      },
